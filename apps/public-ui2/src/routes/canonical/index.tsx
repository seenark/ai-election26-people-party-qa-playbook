...
function RouteComponent() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#1B2A3F] via-[#1a2637] to-[#162033]">
      ...
      <div className="relative flex justify-center p-8 text-white">
        <div className="w-full max-w-7xl">
          ...
          <div className="mb-12">
            ...
            <h1 className="text-5xl font-bold mb-3 text-white bg-clip-text">Canonical Policies</h1>
